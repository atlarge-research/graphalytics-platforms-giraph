 ...
 * @author Tim Hegeman
 */
public class LocalClusteringCoefficientVertexInputFormat extends TextVertexValueInputFormat<LongWritable, DoubleWritable, NullWritable> {

	@Override
	public TextVertexValueReader createVertexValueReader(InputSplit split, TaskAttemptContext context)
			throws IOException {
		return new LocalClusteringCoefficientVertexReader();
	}

	private class LocalClusteringCoefficientVertexReader extends TextVertexValueReaderFromEachLine {
