 ...
 * @author Tim Hegeman
 */
public final class SingleSourceShortestPathConfiguration {

	/**
	 * Configuration key for the source vertex of the algorithm
	 */
	public static final String SOURCE_VERTEX_KEY = "graphalytics.sssp.source-vertex";
	...
	public static final LongConfOption SOURCE_VERTEX = new LongConfOption(
			SOURCE_VERTEX_KEY, -1, "Source vertex for the single source shortest path algorithm");

	private SingleSourceShortestPathConfiguration() {
		//
	}
}
